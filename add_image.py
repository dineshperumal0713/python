...
penguin_image = pygame.transform.scale(pygame.image.load("penguin.png").convert_alpha(),(100,100))  
penguin_react = penguin_image.get_rect(center = (screen_width//2,screen_height//2-30))
...
def game_loop():
    ...
    while running:
        ...
        display_surface.blit(penguin_image,penguin_react)
